...
const HOST = 'http://webtours.load-test.ru:1080';
const CGI = `${HOST}/cgi-bin`;

const CREDIT_CARD = __ENV.CREDIT_CARD || '1234567890123456';
const EXP_DATE = __ENV.EXP_DATE || '12/26';
...
export default function () {
  ...
  group('Open frameset', () => {
    const res = http.get(`${HOST}/webtours/`, { redirects: 5 });
    check(res, {
  ...
  group('Itinerary (booked flights)', () => {
    const res = http.get(`${CGI}/welcome.pl?page=itinerary`, { redirects: 5 });
    check(res, {
